  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      if (downloadPathUri && Platform.OS === 'android') {
        ...
        if (notifee) {
          await notifee.displayNotification({ title: "Download Complete", body: "Expense report saved to your chosen downloads folder.", android: { channelId: 'daily_accounts', showTimestamp: true } });
        }
      ...
      if (notifee) {
        await notifee.displayNotification({ title: "Download Failed", body: `Failed to generate expense report.`, android: { channelId: 'daily_accounts', showTimestamp: true } });
      }
